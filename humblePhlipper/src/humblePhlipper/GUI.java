...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        textField1.setToolTipText("`discordWebhook` - discord webhook for on the hour and end of session notifications");
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.weightx = 1.0;
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel18.add(pricingComboBox, gbc);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel19.add(pricingOffsetSpinner, gbc);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        paramsPanel.add(panel20, gbc);
        panel20.setBorder(BorderFactory.createTitledBorder(null, "Bid Priority", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        panel24.add(priorityCapitalBindingSlider, BorderLayout.CENTER);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        panel23.add(panel26, gbc);
        priorityVolSlider = new JSlider();
        priorityVolSlider.setValue(50);
        panel26.add(priorityVolSlider, BorderLayout.CENTER);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        panel23.add(panel27, gbc);
        priorityProfitSlider = new JSlider();
        priorityProfitSlider.setValue(50);
        panel27.add(priorityProfitSlider, BorderLayout.CENTER);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel29.add(capitalBindingVeTextField, gbc);
        ...
        panel33.setBorder(BorderFactory.createTitledBorder(null, "Bid Restrictions", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel39.add(maxVolumeOfAnyBidTextField, gbc);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel40.add(maxValueOfAnyBidTextField, gbc);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel41.add(noSelfCompetingTextField, gbc);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        manualPanel.add(panel43, gbc);
        addItemField = new JTextField();
        addItemField.setText("");
        panel43.add(addItemField, BorderLayout.CENTER);
        ...
        panel45.setBorder(BorderFactory.createTitledBorder(null, "Max 1 Hour Bid/Ask Volume Ratio", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel45.add(maxBidAskVolRatioField, gbc);
        ...
        panel46.setBorder(BorderFactory.createTitledBorder(null, "Number of Items to Select", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel46.add(numToSelectSpinner, gbc);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel46.add(generateButton, gbc);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        panel44.add(panel47, gbc);
        panel47.setBorder(BorderFactory.createTitledBorder(null, "Max Bid Price", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel47.add(maxBidPriceField, gbc);
        ...
        panel49.setBorder(BorderFactory.createTitledBorder(null, "Min 1 Hour Volume", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        panel50.setBorder(BorderFactory.createTitledBorder(null, "Min Margin", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel50.add(minMarginField, gbc);
        ...
        panel51.setBorder(BorderFactory.createTitledBorder(null, "Restrictions", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        gbc.weighty = 1.0;
        gbc.anchor = GridBagConstraints.WEST;
        panel51.add(membersCheckBox, gbc);
        ...
        gbc.weighty = 1.0;
        gbc.anchor = GridBagConstraints.WEST;
        panel51.add(tradeRestrictedCheckBox, gbc);
        ...
        selectionsPanel.add(panel52, BorderLayout.SOUTH);
        ...
        panel53.add(removeItemField, BorderLayout.CENTER);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        panel52.add(panel54, gbc);
        removeButton = new JButton();
        removeButton.setText("Remove by ID");
        panel54.add(removeButton, BorderLayout.CENTER);
