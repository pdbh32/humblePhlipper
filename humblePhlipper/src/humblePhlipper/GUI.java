...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        paramsPanel.add(panel35, gbc);
        panel35.setBorder(BorderFactory.createTitledBorder(null, "Offer Restrictions", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel37.add(maxBidVolField, gbc);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel38.add(maxBidValueField, gbc);
        ...
        gbc.weighty = 1.0;
        gbc.anchor = GridBagConstraints.WEST;
        panel39.add(noSelfCompetingCheckBox, gbc);
        ...
        gbc.weighty = 1.0;
        gbc.anchor = GridBagConstraints.WEST;
        panel40.add(cancelPartialBidsCheckBox, gbc);
        ...
        gbc.weighty = 1.0;
        gbc.anchor = GridBagConstraints.WEST;
        panel41.add(neverSellAtLossCheckBox, gbc);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel43.add(maxVolumeOfAnyBidTextField, gbc);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel44.add(maxValueOfAnyBidTextField, gbc);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel45.add(noSelfCompetingTextField, gbc);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel46.add(cancelPartiallyFulfilledBidsTextField, gbc);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel47.add(neverSellAtLossTextField, gbc);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        manualPanel.add(panel48, gbc);
        addButton = new JButton();
        addButton.setText("Add by Name or ID");
        panel48.add(addButton, BorderLayout.CENTER);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        manualPanel.add(panel49, gbc);
        addItemField = new JTextField();
        addItemField.setText("");
        panel49.add(addItemField, BorderLayout.CENTER);
        ...
        panel51.setToolTipText("`maxBidAskVolRatio` - maximum bid price of candaidate automatic selections");
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.weightx = 1.0;
        ...
        panel51.setBorder(BorderFactory.createTitledBorder(null, "Max 1 Hour Bid/Ask Volume Ratio", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel51.add(maxBidAskVolRatioField, gbc);
        ...
        panel52.setBorder(BorderFactory.createTitledBorder(null, "Generate", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel52.add(generateButton, gbc);
        ...
        panel53.setBorder(BorderFactory.createTitledBorder(null, "Max Bid Price", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel53.add(maxBidPriceField, gbc);
        ...
        panel55.setBorder(BorderFactory.createTitledBorder(null, "Min 1 Hour Volume", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        panel56.setBorder(BorderFactory.createTitledBorder(null, "Min Margin", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel56.add(minMarginField, gbc);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        panel54.add(panel57, gbc);
        panel57.setBorder(BorderFactory.createTitledBorder(null, "Restrictions", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        gbc.weighty = 1.0;
        gbc.anchor = GridBagConstraints.WEST;
        panel57.add(membersCheckBox, gbc);
        ...
        gbc.weighty = 1.0;
        gbc.anchor = GridBagConstraints.WEST;
        panel57.add(tradeRestrictedCheckBox, gbc);
        ...
        selectionsPanel.add(panel58, BorderLayout.SOUTH);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        panel58.add(panel59, gbc);
        resetButton = new JButton();
        resetButton.setText("Clear Selections and Omissions");
        panel59.add(resetButton, BorderLayout.CENTER);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        panel58.add(panel60, gbc);
        omitButton = new JButton();
        omitButton.setText("Omit by Name or ID");
        panel60.add(omitButton, BorderLayout.EAST);
        omitItemField = new JTextField();
        panel60.add(omitItemField, BorderLayout.CENTER);
