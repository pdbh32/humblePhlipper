...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel38.add(maxVolumeOfAnyBidTextField, gbc);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel39.add(maxValueOfAnyBidTextField, gbc);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        manualPanel.add(panel41, gbc);
        addItemField = new JTextField();
        addItemField.setText("");
        panel41.add(addItemField, BorderLayout.CENTER);
        ...
        panel43.setBorder(BorderFactory.createTitledBorder(null, "Max 1 Hour Bid/Ask Volume Ratio", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel43.add(maxBidAskVolRatioField, gbc);
        ...
        panel44.setBorder(BorderFactory.createTitledBorder(null, "Number of Items to Select", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel44.add(numToSelectSpinner, gbc);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel44.add(generateButton, gbc);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        panel42.add(panel45, gbc);
        panel45.setBorder(BorderFactory.createTitledBorder(null, "Max Bid Price", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel45.add(maxBidPriceField, gbc);
        ...
        panel47.setBorder(BorderFactory.createTitledBorder(null, "Min 1 Hour Volume", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        panel48.setBorder(BorderFactory.createTitledBorder(null, "Min Margin", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel48.add(minMarginField, gbc);
        ...
        panel49.setBorder(BorderFactory.createTitledBorder(null, "Restrictions", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        gbc.weighty = 1.0;
        gbc.anchor = GridBagConstraints.WEST;
        panel49.add(membersCheckBox, gbc);
        ...
        gbc.weighty = 1.0;
        gbc.anchor = GridBagConstraints.WEST;
        panel49.add(tradeRestrictedCheckBox, gbc);
        ...
        selectionsPanel.add(panel50, BorderLayout.SOUTH);
        ...
        panel51.add(removeItemField, BorderLayout.CENTER);
        ...
        panel52.add(removeButton, BorderLayout.CENTER);
