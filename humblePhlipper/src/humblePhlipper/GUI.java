...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel7.add(discordWebhookField, gbc);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        miscellaneousPanel.add(panel8, gbc);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel9.add(timeoutMinutesTextField, gbc);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel10.add(profitCutoffTextField, gbc);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel11.add(maxVolumeOfAnyBidTextField, gbc);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel12.add(maxValueOfAnyBidTextField, gbc);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel13.add(closeClientOnStopTextField, gbc);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        paramsPanel.add(panel15, gbc);
        panel15.setBorder(BorderFactory.createTitledBorder(null, "Pricing", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel17.add(basePricingTextField, gbc);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel18.add(minAPICallIntervalTextField, gbc);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel19.add(pricingOffsetTextField, gbc);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel20.add(bandwidthSaverModeTextField, gbc);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel22.add(pricingComboBox, gbc);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel23.add(apiIntervalSpinner, gbc);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel24.add(pricingOffsetSpinner, gbc);
        ...
        gbc.weighty = 1.0;
        gbc.anchor = GridBagConstraints.WEST;
        panel25.add(bandwidthSaverCheckBox, gbc);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        paramsPanel.add(panel26, gbc);
        panel26.setBorder(BorderFactory.createTitledBorder(null, "Bid Priority", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        panel30.add(priorityCapitalBindingSlider, BorderLayout.CENTER);
        ...
        panel31.add(label1, BorderLayout.CENTER);
        ...
        panel32.add(priorityVolSlider, BorderLayout.CENTER);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        panel29.add(panel33, gbc);
        priorityProfitSlider = new JSlider();
        priorityProfitSlider.setValue(50);
        panel33.add(priorityProfitSlider, BorderLayout.CENTER);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel35.add(capitalBindingVeTextField, gbc);
        final JPanel panel36 = new JPanel();
        panel36.setLayout(new CardLayout(0, 0));
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.weightx = 1.0;
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel37.add(a1HourVolumeVeTextField, gbc);
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel38.add(profitMarginVeTextField, gbc);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        manualPanel.add(panel40, gbc);
        addItemField = new JTextField();
        addItemField.setText("");
        panel40.add(addItemField, BorderLayout.CENTER);
        ...
        panel42.setBorder(BorderFactory.createTitledBorder(null, "Max 1 Hour Bid/Vol Volume Ratio", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel42.add(maxBidAskVolRatioField, gbc);
        ...
        panel43.setBorder(BorderFactory.createTitledBorder(null, "Number of Items to Select", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel43.add(numToSelectSpinner, gbc);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel43.add(generateButton, gbc);
        ...
        panel44.setBorder(BorderFactory.createTitledBorder(null, "Max Bid Price", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel44.add(maxBidPriceField, gbc);
        ...
        panel46.setBorder(BorderFactory.createTitledBorder(null, "Min 1 Hour Volume", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        panel47.setBorder(BorderFactory.createTitledBorder(null, "Min Margin", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel47.add(minMarginField, gbc);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        panel45.add(panel48, gbc);
        panel48.setBorder(BorderFactory.createTitledBorder(null, "Restrictions", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        gbc.weighty = 1.0;
        gbc.anchor = GridBagConstraints.WEST;
        panel48.add(membersCheckBox, gbc);
        ...
        gbc.weighty = 1.0;
        gbc.anchor = GridBagConstraints.WEST;
        panel48.add(tradeRestrictedCheckBox, gbc);
        ...
        selectionsPanel.add(panel49, BorderLayout.SOUTH);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        panel49.add(panel50, gbc);
        removeItemField = new JTextField();
        panel50.add(removeItemField, BorderLayout.CENTER);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        panel49.add(panel51, gbc);
        removeButton = new JButton();
        removeButton.setText("Remove by ID");
        panel51.add(removeButton, BorderLayout.CENTER);
