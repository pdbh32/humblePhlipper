...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        neverSellAtLossTextField.setText("Never Sell At Loss");
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.weightx = 1.0;
        ...
        panel53.setBorder(BorderFactory.createTitledBorder(null, "Min 1 Hour Volume", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        panel54.setBorder(BorderFactory.createTitledBorder(null, "Min Margin", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        gbc.anchor = GridBagConstraints.WEST;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel54.add(minMarginField, gbc);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        panel52.add(panel55, gbc);
        panel55.setBorder(BorderFactory.createTitledBorder(null, "Restrictions", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        gbc.weighty = 1.0;
        gbc.anchor = GridBagConstraints.WEST;
        panel55.add(membersCheckBox, gbc);
        ...
        gbc.weighty = 1.0;
        gbc.anchor = GridBagConstraints.WEST;
        panel55.add(tradeRestrictedCheckBox, gbc);
        ...
        selectionsPanel.add(panel56, BorderLayout.SOUTH);
